    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable())
            ...
            .authorizeHttpRequests(auth ->
                auth
//                .requestMatchers(HttpMethod.GET, "/student/**").hasAnyRole("ADMIN", "TRAINER", "COORDINATOR", "STUDENT")
//	                .requestMatchers(HttpMethod.GET, "/batch/**").hasAnyRole("ADMIN", "TRAINER", "COORDINATOR", "STUDENT")
//	                .requestMatchers(HttpMethod.GET, "/event/**").hasAnyRole("ADMIN", "TRAINER", "COORDINATOR", "STUDENT")
